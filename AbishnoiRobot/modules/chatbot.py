...
import html
import requests
import AbishnoiRobot.modules.sql.chatbot_sql as sql
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "「 ᴀʙɢ 𒆜 ʀᴏʙᴏᴛ 」 ᴄʜᴀᴛʙᴏᴛ ᴅɪsᴀʙʟᴇᴅ ʙʏ {}.".format(
...
def kukiadd(update: Update, context: CallbackContext) -> str:
    ...
    if match:
        ...
        if is_kuki:
            ...
            update.effective_message.edit_text(
                "「 ᴀʙɢ 𒆜 ʀᴏʙᴏᴛ 」 ᴄʜᴀᴛʙᴏᴛ ᴇɴᴀʙʟᴇᴅ ʙʏ {}.".format(
                    mention_html(user.id, user.first_name)
                ),
                parse_mode=ParseMode.HTML,
            )
...
def list_all_chats(update: Update, context: CallbackContext):
    ...
    text = "<b>Abishnoi Enabled Chats</b>\n"
    for chat in chats:
        try:
